  ...
  return (
    <section className="bg-lightNature py-16">
      <ContainerWrapper>
        ...
        <motion.div className="space-y-16" {...textFadeIn}>
            ...
            subSections={[
              {
                ...
                content:
                  "Vi genomför en noggrann inspektion av din nuvarande solcellsanläggning för att identifiera möjliga förbättringsområden och se hur den bäst kan optimeras.",
              },
              {
                number: 2,
                heading: "Möjligheter & begränsningar",
                content:
                  "Efter inspektionen av ert system klargör vi vilka batterilager som är kompatibla att ansluta och hur storleken på batteriet påverkar er energiförbrukning.",
              },
              {
                number: 3,
                heading: "Installation",
                content:
                  "Vi ser till att välja den teknik som säkerställer att ditt system är utrustat för framtidens energibehov och optimerar det för era behov.",
              },
              {
                number: 4,
                heading: "Integration och optimering",
                content:
                  "Vi integrerar den nya teknologin med ditt befintliga system för att maximera energibesparingar och effektivitet.",
              },
            ]}
          />
        </motion.div>
