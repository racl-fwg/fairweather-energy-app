  ...
  return (
    <section id="about" className="py-12 bg-lightNeon">
      <ContainerWrapper>
        ...
        <motion.div
          className="mb-16 mt-12 text-center max-w-4xl mx-auto"
          {...textFadeIn}
        >
          <div className="text-left md:text-center text-4xl font-semibold text-darkNature mb-8">
            Om oss – för bättre energilösningar
          </div>
          <div className="text-left md:text-center text-base sm:text-lg text-darkNature leading-7 mb-8">
        ...
        {/* Horizontal Line */}
        <motion.hr className="border-t-1 border-darkNature mb-16" {...textFadeIn} />
        ...
        <motion.div className="text-center" {...textFadeIn}>
          <div className="text-3xl xl:text-4xl font-semibold text-darkNature mb-4">
            Låt oss hjälpa er på vägen mot en effektivare energilösning!
          </div>
          <div className="text-base sm:text-lg text-darkNature leading-7 max-w-4xl mx-auto">
