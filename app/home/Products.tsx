  ...
  return (
    <section className="py-16 bg-lightNeon">
      <ContainerWrapper>
        {/* Title */}
        <motion.h2
          className="text-3xl md:text-4xl font-semibold text-nature text-center mb-12"
          {...textFadeIn}
        >
        ...
        <div className="bg-white shadow-xl rounded-2xl py-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <motion.div
              className="md:col-span-2 lg:col-span-4 relative rounded-2xl overflow-hidden"
              {...textFadeIn}
            >
            ...
            <motion.div
              className="md:col-span-2 lg:col-span-1 flex md:flex-wrap lg:flex-col justify-evenly items-stretch lg:justify-start lg:space-y-[5px] overflow-hidden lg:overflow-visible h-auto lg:h-[500px]"
              {...textFadeIn}
            >
              {products.map((product) => (
                <div
                  ...
                  className={`relative cursor-pointer bg-white w-[45%] md:w-[24%] lg:w-full h-[106px] lg:h-[120px] rounded-lg overflow-hidden shadow-lg text-center ${
            ...
            {/* Description Section */}
            <motion.div
              className="lg:col-span-3 p-4 mt-0"
              {...textFadeIn}
            >
            ...
            {/* Explore Button */}
            <motion.div
              className="lg:col-span-2 flex items-center justify-end"
              {...textFadeIn}
            >
              <ArrowButton
